...
class place_block_dialog(tk.Toplevel):
    ...
    def go_pressed(self, *args, **kwargs):
        ...
        if place_type == "absolute":
            ...
            #place_relative(self, ref_block, ref_pos='right', ref_distance=4, xshift=0, yshift=0):
            ...
            block.place_relative(ref_block=rel_block, ref_pos=rel_pos, ref_distance=4, xshift=0, yshift=0)
