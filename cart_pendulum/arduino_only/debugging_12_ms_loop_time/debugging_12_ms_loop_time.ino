...
void loop()
{
  if (ISR_Happened == 1){
   ...
   dual_motors.send_commands(0,0);
   digitalWrite(timing_pin_1, LOW);
   digitalWrite(timing_pin_2, HIGH);
   G_block.find_output(t_sec);
   digitalWrite(timing_pin_2, LOW);



   digitalWrite(timing_pin_3, HIGH);
