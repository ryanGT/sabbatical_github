...
class sniffer:
   ...
   def __init__(self, SCL, SDA, set_as_inputs=True):
      """
      ...
      if set_as_inputs:
         pigpio.set_mode(SCL, pigpio.INPUT)
         pigpio.set_mode(SDA, pigpio.INPUT)

      self.cbA = pigpio.callback(SCL, pigpio.EITHER_EDGE, self._cb)
      self.cbB = pigpio.callback(SDA, pigpio.EITHER_EDGE, self._cb)
...
if __name__ == "__main__":
   ...
   s = I2C_sniffer.sniffer(1, 0, False) # leave gpios 1/0 in I2C mode
